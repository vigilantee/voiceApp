  ...
  return (
    <View style={styles.videoarea}>
      <View style={styles.header}>
        ...
        />
        <Button
          title={props.recognized ? 'Stop' : 'Speak'}
          onPress={props.recognized ? props.stop : props.start}
        />
        <Button title="Search" onPress={() => loadVideoList(props.noun)} />
      </View>
      {loading ? (
          ...
          {orientation === DEVICE_ORIENTATION.PORTRAIT ? (
              ...
              <Text style={styles.bold}>
                ...
                <Text style={styles.frame}>
                  {selectedVideoChannel != ''
                    ? selectedVideoChannel.length > 40
                      ? selectedVideoChannel.substring(0, 40) + '...'
                      : selectedVideoChannel
                    : 'No channel'}
                </Text>
              </Text>
            ...
            <View style={styles.bottom}>
              ...
              <Text style={styles.bold}>
                ...
                <Text style={styles.frame}>
                  {selectedVideoChannel != ''
                    ? selectedVideoChannel.length > 78
                      ? selectedVideoChannel.substring(0, 78) + '...'
                      : selectedVideoChannel
                    : 'No channel'}
                </Text>
              </Text>
